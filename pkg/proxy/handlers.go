...
// CorsMiddleware returns a middleware that adds CORS headers to the response.
func CorsMiddleware(fn func(w http.Header), origins ...string) func(http.HandlerFunc) http.HandlerFunc {
